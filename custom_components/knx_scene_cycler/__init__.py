...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Absolut stabil: Wir lesen die Tasten ausnahmslos aus dem data-Feld aus
    functions = entry.data.get("functions", [])
    ...
    # Lädt die Plattformen sauber neu, wenn das data-Feld aktualisiert wurde
